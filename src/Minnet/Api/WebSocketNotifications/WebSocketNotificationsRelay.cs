...
using Autofac;
using Minnet.Api.WebSocketNotifications;
...
public class WebSocketNotificationsRelay : WebSocketHandler
{
    ...
    public override async Task OnConnected(WebSocket socket)
    {
        ...
        var greeting = ToJson(WsNotificationType.Greeting, new { Message = "Connected to Minnet notification relay" });
