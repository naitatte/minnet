...
using Autofac;
using Minnet.Api;
using Minnet.Banning;
using Minnet.Blockchain.Bitcoin;
using Minnet.Blockchain.Cryptonote;
using Minnet.Blockchain.Equihash;
using Minnet.Blockchain.Ethereum;
...
using Minnet.Payments.PaymentSchemes;
using Minnet.Time;
...
using Microsoft.IO;
using Minnet.Blockchain.Ergo;
using Minnet.Nicehash;
using Minnet.Pushover;
