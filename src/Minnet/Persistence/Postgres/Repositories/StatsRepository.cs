...
using Minnet.Persistence.Model.Projections;
using Minnet.Persistence.Repositories;
using Minnet.Time;
using MinerStats = Minnet.Persistence.Model.Projections.MinerStats;

namespace Minnet.Persistence.Postgres.Repositories;
