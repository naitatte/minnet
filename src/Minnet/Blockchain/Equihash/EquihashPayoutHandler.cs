using Autofac;
using AutoMapper;
using Minnet.Blockchain.Bitcoin;
using Minnet.Blockchain.Bitcoin.DaemonResponses;
using Minnet.Blockchain.Equihash.Configuration;
using Minnet.Blockchain.Equihash.DaemonRequests;
using Minnet.Blockchain.Equihash.DaemonResponses;
...
using Minnet.Persistence.Repositories;
using Minnet.Time;
using NBitcoin;
using Newtonsoft.Json.Linq;
using Contract = Minnet.Contracts.Contract;
using IBlockRepository = Minnet.Persistence.Repositories.IBlockRepository;
